...
SEARCH_PROVIDERS = [
    ("&1. Google", [u"https://www.google.com/search?&q=%s"]),
    ("&2. SpanishDict", [u"https://www.spanishdict.com/translate/%s"]),
    ("&3. Google Images", [u"https://google.com/search?q=%s&tbm=isch"]),
    ("&4. Google Translate", [u"https://translate.google.com/?sl=es&tl=en&text=%s&op=translate"]),
    ("&5. Jisho", [u"https://jisho.org/search/%s"]),
    ("&6. Google Translate JP", [u"https://www.google.com/search?tbm=isch&q=sites:.jp+%s"])
]
